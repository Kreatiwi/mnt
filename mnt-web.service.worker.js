...
/** @type {string} */
const CACHE_VERSION = '1737892568|5225545783';
/** @type {string} */
const CACHE_PREFIX = 'MNT-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'mnt-web.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["mnt-web.html","mnt-web.js","mnt-web.offline.html","mnt-web.icon.png","mnt-web.apple-touch-icon.png","mnt-web.worker.js","mnt-web.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["mnt-web.wasm","mnt-web.pck"];
